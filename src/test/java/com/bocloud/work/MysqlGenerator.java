	...
	public static void main(String[] args) {
		...
		// .setControllerName("%sAction")
				...
				new DataSourceConfig().setDbType(DbType.MYSQL)// 数据库类型
						...
						}).setDriverName("com.mysql.jdbc.Driver").setUsername("root").setPassword("password")
						.setUrl("jdbc:mysql://192.168.2.22:3306/work?characterEncoding=utf8"))
				.setStrategy(
						// 策略配置
						new StrategyConfig()
								...
								// 自定义实体，公共字段
								.setSuperEntityColumns(new String[] { "id" }).setTableFillList(tableFillList)
				// 自定义 mapper 父类
				...
				.setPackageInfo(
						// 包配置
						new PackageConfig().setModuleName("work").setParent("com.bocloud")// 自定义包路径
